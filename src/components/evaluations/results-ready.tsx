...
export function ResultsReady({
  ...
  shareUrl,
  evaluationId,
  evaluationType = "INITIAL", // Default to INITIAL if not provided
}: ResultsReadyProps) {
  ...
  // Check if this is an initial evaluation
    ...
    try {
      ...
      const response = await fetch("/api/send-results", {
        ...
        body: JSON.stringify({
          ...
          evaluationType, // Pass the evaluation type to the API
        }),
      });
    ...
    <div className="flex flex-col min-h-screen md:flex-row">
      ...
      <div className="w-full md:w-3/5 p-4 md:p-16 flex flex-col justify-center">
        <div className="max-w-lg mx-auto space-y-8">
          ...
          {/* Advanced Evaluation CTA - Only show for INITIAL evaluations */}
          {isInitialEvaluation && (
            <motion.div
