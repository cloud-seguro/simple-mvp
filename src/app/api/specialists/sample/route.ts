  ...
  try {
    ...
    const specialist = await prisma.specialist.create({
      data: {
        ...
        linkedinProfileUrl: "https://linkedin.com/in/anarod",
    ...
    const specialist2 = await prisma.specialist.create({
      data: {
        ...
        linkedinProfileUrl: "https://linkedin.com/in/carlosmendez",
    ...
    const specialist3 = await prisma.specialist.create({
      data: {
        ...
        linkedinProfileUrl: "https://linkedin.com/in/elenagomez",
